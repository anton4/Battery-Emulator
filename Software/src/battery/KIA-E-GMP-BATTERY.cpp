...
const uint8_t numPoints = 31;
const uint16_t SOC[] = {10000, 9700, 9400, 9100, 8800, 8500, 8200, 7900, 7600, 7300, 
                        7000, 6700, 6400, 6100, 5800, 5500, 5200, 4900, 4600, 4300, 
                        4000, 3700, 3400, 3100, 2800, 2500, 2200, 1900, 1600, 1300, 
                        1000, 700, 400, 200, 0};
const uint16_t voltage[] = {7970, 7920, 7870, 7820, 7770, 7720, 7670, 7620, 7570, 7520, 
                            7470, 7420, 7370, 7320, 7270, 7220, 7170, 7120, 7070, 7020, 
                            6970, 6920, 6870, 6820, 6770, 6720, 6670, 6620, 6570, 6520, 6470, 6420};
...
void update_values_battery() {  //This function maps all the values fetched via CAN to the correct parameters used for modbus
  ...
  // Replace the cell voltage-based SoC calculation with pack voltage-based calculation
  SOC_estimated_lowest = estimateSOC(batteryVoltage);  // Convert batteryVoltage (in dV) to mV
  SOC_estimated_highest = SOC_estimated_lowest;  // Since we are using pack voltage, we don't have separate min/max
  datalayer.battery.status.real_soc = SOC_estimated_lowest;  // Use the estimated SoC based on pack voltage
#else
